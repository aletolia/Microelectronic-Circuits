...
由于$α\simeq1$，所以总增益可以近似看作集电极总电阻和发射级总电阻之比，并且我们注意到，总增益大小几乎与BJT的$β$值无关，电路的输入电阻也很低（$1/g_m$)，以及类似于共射放大器的放大倍数和较高的输出电阻。共基配置的放大器由于其较低的输入电阻，因而其作为电压放大器的价值较低，不过由于其有出色的高频响应，因此被广泛应用于高频放大器中
